 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterAlert")
public class crcConverterAlert implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        panelSubctgBean data = context.getApplication().evaluateExpressionGet(context,
                "#{panelSubctgBean}", panelSubctgBean.class);

        for (caracteristica caracteristica : data.getLstCrcAlerts()) {
