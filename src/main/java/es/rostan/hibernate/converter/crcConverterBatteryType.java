 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterBatteryType")
public class crcConverterBatteryType implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcBatteryType()) {
