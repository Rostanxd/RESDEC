 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterCardslot")
public class crcConverterCardslot implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcCardslot()) {
