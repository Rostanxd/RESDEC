 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterChipset")
public class crcConverterChipset implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcChipset()) {
