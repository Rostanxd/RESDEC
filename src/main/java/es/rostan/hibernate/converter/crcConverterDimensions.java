 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterDimensions")
public class crcConverterDimensions implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcDimensions()) {
