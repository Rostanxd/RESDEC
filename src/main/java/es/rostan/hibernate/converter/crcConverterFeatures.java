 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterFeatures")
public class crcConverterFeatures implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcFeatures()) {
