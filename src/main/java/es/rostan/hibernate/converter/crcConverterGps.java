 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterGps")
public class crcConverterGps implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcGps()) {
