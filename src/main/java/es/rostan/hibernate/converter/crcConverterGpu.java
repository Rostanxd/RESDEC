 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterGpu")
public class crcConverterGpu implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcGpu()) {
