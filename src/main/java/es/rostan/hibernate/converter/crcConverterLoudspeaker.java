 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterLoudspeaker")
public class crcConverterLoudspeaker implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcLoudspeaker()) {
