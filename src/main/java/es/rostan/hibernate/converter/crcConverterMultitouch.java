 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterMultitouch")
public class crcConverterMultitouch implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcMultiTouch()) {
