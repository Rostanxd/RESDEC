 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterMusicplay")
public class crcConverterMusicplay implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcMusicplay()) {
