 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterOs")
public class crcConverterOs implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcOs()) {
