 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterOther")
public class crcConverterOther implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcOther()) {
