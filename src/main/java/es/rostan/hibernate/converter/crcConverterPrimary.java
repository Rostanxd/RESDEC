 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterPrimary")
public class crcConverterPrimary implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcPrimary()) {
