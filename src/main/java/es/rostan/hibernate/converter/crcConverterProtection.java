 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterProtection")
public class crcConverterProtection implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcProtection()) {
