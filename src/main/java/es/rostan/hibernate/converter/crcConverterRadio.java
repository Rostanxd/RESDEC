 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterRadio")
public class crcConverterRadio implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcRadio()) {
