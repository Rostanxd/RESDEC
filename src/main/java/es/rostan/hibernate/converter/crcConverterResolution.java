 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterResolution")
public class crcConverterResolution implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcResolution()) {
