 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterSecondary")
public class crcConverterSecondary implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcSecondary()) {
