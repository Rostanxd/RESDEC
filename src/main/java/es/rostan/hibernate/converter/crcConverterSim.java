 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterSim")
public class crcConverterSim implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcSim()) {
