 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterSize")
public class crcConverterSize implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcSize()) {
