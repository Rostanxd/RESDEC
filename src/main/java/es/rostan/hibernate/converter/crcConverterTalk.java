 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterTalk")
public class crcConverterTalk implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcTalktime()) {
