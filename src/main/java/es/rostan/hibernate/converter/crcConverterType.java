 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterType")
public class crcConverterType implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcType()) {
