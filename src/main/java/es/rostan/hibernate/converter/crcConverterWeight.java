 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterWeight")
public class crcConverterWeight implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcWeight()) {
