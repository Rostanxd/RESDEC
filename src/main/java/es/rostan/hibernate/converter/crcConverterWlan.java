 ...
 */
@FacesConverter(forClass = caracteristica.class , value = "crcConverterWlan")
public class crcConverterWlan implements Converter {
    @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        for (caracteristica caracteristica : data.getLstCrcWlan()) {
